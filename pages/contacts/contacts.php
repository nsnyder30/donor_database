		...
		function cntCtl($scope, $http, $uibModal){
			...
			$scope.cnt_filters = function(){
				return function(cnt) {
					...
					flt_pass = true;
					flt_pass = flt_pass && first_val.match(first_flt);
					flt_pass = flt_pass && last_val.match(last_flt);
					...
					flt_pass = flt_pass && email_val.match(email_flt);
					flt_pass = flt_pass && fb_profile_val.match(fb_profile_flt);
					flt_pass = flt_pass && phone_val.match(phone_flt);
					flt_pass = flt_pass && street_addr_val.match(street_addr_flt);
					flt_pass = flt_pass && city_val.match(city_flt);
					flt_pass = flt_pass && state_val.match(state_flt);
					flt_pass = flt_pass && zip_val.match(zip_flt);
					flt_pass = flt_pass && country_val.match(country_flt);
					flt_pass = flt_pass && mailchimp_val.match(mailchimp_flt);
					flt_pass = flt_pass && org_text_val.match(org_text_flt);
					flt_pass = flt_pass && personal_details_val.match(personal_details_flt);
					return flt_pass
				};
			};
			/*------------------------------------------------------------------------------------------------------------*/			
